...
def ewise_eq(a, b, out):
    out.array[:] = (a.array == b.array).astype(_datatype)


def scalar_eq(a, val, out):
    out.array[:] = (a.array == val).astype(_datatype)
